...
public class SynchDGraphPlotterPanel extends SynchSharedGraphPlotterPanel {
	
	private static final long serialVersionUID = 1L;
	
	private List<Double> usageList = null;
	...
	public SynchDGraphPlotterPanel() {
		this("GraphPanel", 1, 1);
	}

	public SynchDGraphPlotterPanel(String name, int width, int height) {
		this(name, width, height, false);		
	}

	public SynchDGraphPlotterPanel(String name, int width, int height, boolean flag) {
		this(name, width, height, flag, new SynchBubblePanel(width, height));		
	}

	public SynchDGraphPlotterPanel(String name, int width, int height, boolean flag, SynchBubblePanel bubblePanel) {
	...
	public void setUsageList(List<Double> usageList) {
	...
	public double calculateEquivalentYCoordinate(double currentValue) {
