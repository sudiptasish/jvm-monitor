...
public class SynchBubblePanel extends SynchBasicGraphPanel {

	private static final long serialVersionUID = 1L;
	
	public SynchXGraphLine[] xLine = null;
	public SynchYGraphLine[] yLine = null;
	...
	public SynchBubblePanel(int panel_width, int panel_height) {
	...
	private class MouseListenerHandler extends MouseAdapter {
		private SynchBasicGraphPanel graphPanel = null;
		
		public MouseListenerHandler(SynchBasicGraphPanel panel) {
			graphPanel = panel;
		}
	...
	private class MouseMotionListenerHandler implements MouseMotionListener {
		...
		public MouseMotionListenerHandler(SynchBasicGraphPanel panel) {
			graphPanel = panel;
		}
