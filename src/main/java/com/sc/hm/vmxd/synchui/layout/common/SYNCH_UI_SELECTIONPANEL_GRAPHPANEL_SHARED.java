...
public class SYNCH_UI_SELECTIONPANEL_GRAPHPANEL_SHARED {
	...
	public SYNCH_UI_SELECTIONPANEL_GRAPHPANEL_SHARED() {
		this("1", "", Color.GREEN, Color.GREEN, 4, true);
	}

	public SYNCH_UI_SELECTIONPANEL_GRAPHPANEL_SHARED(String span
