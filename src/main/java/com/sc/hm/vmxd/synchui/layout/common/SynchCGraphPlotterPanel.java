...
public class SynchCGraphPlotterPanel extends SynchSharedGraphPlotterPanel {
	...
	public SynchCGraphPlotterPanel() {
		this("GraphPanel", 1, 1);
	}

	public SynchCGraphPlotterPanel(String name, int width, int height) {
		this(name, width, height, false);		
	}

	public SynchCGraphPlotterPanel(String name, int width, int height, boolean flag) {
		this(name, width, height, flag, new SynchBubblePanel(width, height));		
	}

	public SynchCGraphPlotterPanel(String name, int width, int height, boolean flag, SynchBubblePanel bubblePanel) {
