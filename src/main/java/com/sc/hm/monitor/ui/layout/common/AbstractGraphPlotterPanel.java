...
public abstract class AbstractGraphPlotterPanel extends JPanel implements GraphPlotterProps {
	...
	public AbstractGraphPlotterPanel(String name, int width, int height, boolean flag) {
		super();
		panelName = name;
		this.width = width;
		this.height = height;
