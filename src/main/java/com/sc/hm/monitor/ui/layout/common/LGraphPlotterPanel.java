...
public class LGraphPlotterPanel extends SharedGraphPlotterPanel {
	...
	public LGraphPlotterPanel() {
		this("GraphPanel", 1, 1);
	}

	public LGraphPlotterPanel(String name, int width, int height) {
		this(name, width, height, false);		
	}

	public LGraphPlotterPanel(String name, int width, int height, boolean flag) {
		this(name, width, height, flag, new BubblePanel(width, height));		
	}

	public LGraphPlotterPanel(String name, int width, int height, boolean flag, BubblePanel bubblePanel) {
	...
	public GBCollector getGbCollector() {
		return gbCollector;
	}

	public void setGbCollector(GBCollector gbCollector) {
	...
	public void plotValues(Graphics2D g) {
		...
		List<Long> usageList = gbCollector.getCollectionCount();
